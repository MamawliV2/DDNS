...
- Never commit `.env` files to version control (`.gitignore` is pre-configured)
- Use strong, unique `JWT_SECRET` values in production (auto-generated by install script)
...
- SSL certificates are auto-renewed via certbot cron job
